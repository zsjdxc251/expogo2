...
export const CHN_LEVELS = [
  ...
  { key: 'writing', label: '写字 · 组词', badge: '✍️', color: '#D4839A', desc: '笔顺描红组词练习', bg: 'rgba(212,131,154,0.12)' },
];
...
const TOPICS_WRITING = {
  hanziWrite: { key: 'hanziWrite', label: '看拼音写字', icon: '✍️', color: '#D4839A', bg: 'rgba(212,131,154,0.15)', desc: '笔顺描红默写', nav: 'HanziWrite' },
  wordBuild:  { key: 'wordBuild',  label: '组词练习', icon: '🧩', color: '#6B8E9B', bg: 'rgba(107,142,155,0.15)', desc: '选词填空组词', nav: 'WordBuild' },
};

const ALL_TOPICS = { ...TOPICS_PINYIN, ...TOPICS_LITERACY, ...TOPICS_WORDS, ...TOPICS_WRITING };
...
export const LEVEL_TOPIC_KEYS = {
  ...
  writing: Object.keys(TOPICS_WRITING),
};
