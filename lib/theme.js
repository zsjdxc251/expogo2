...
export const SUBJECTS = {
  mulForward: { key: 'mulForward', label: '顺着背',   desc: '6×7=?', icon: '📗', color: '#3B82F6', bg: '#EFF6FF' },
  mulBlank:   { key: 'mulBlank',   label: '挖空背',   desc: '?×7=42', icon: '📝', color: '#6366F1', bg: '#EEF2FF' },
  add:        { key: 'add',        label: '加法练习', icon: '➕', color: '#10B981', bg: '#ECFDF5' },
  subtract:   { key: 'subtract',   label: '减法练习', icon: '➖', color: '#F59E0B', bg: '#FFFBEB' },
  divide:     { key: 'divide',     label: '整除计算', icon: '➗', color: '#8B5CF6', bg: '#F5F3FF' },
  divRem:     { key: 'divRem',     label: '余数除法', icon: '🔢', color: '#EC4899', bg: '#FDF2F8' },
  // backward compat for old history records
